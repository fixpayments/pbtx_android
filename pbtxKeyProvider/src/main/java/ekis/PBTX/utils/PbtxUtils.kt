...
class PbtxUtils {
    ...
    companion object {
         ...
         */
        val CURVE_R1: ECDomainParameters?;

        /**
         * EC parameters holder of R1 key type
         */
        val CURVE_PARAMS_R1 = CustomNamedCurves.getByName("secp256r1")

        /**
         * Half curve value of R1 key type (to calculate low S)
         */
        val HALF_CURVE_ORDER_R1: BigInteger?

        /**
         * EC holder of K1 key type
         */
        val CURVE_K1: ECDomainParameters?

        /**
         * EC parameters holder of K1 key type
         */
        val CURVE_PARAMS_K1 = CustomNamedCurves.getByName("secp256k1")
        ...
        fun getProtobufMessage(
            ...
            return protobufKeyModel(createPublicKeyProtoMessage(additionByteAdd(bytes)), alias)
        }
         ...
         *
         * @param r  ECDSASignature.R
         * @param s  ECDSASignature.R
